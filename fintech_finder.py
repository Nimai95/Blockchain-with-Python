...
total_wages = hours * candidate_database[person][3]

# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write('Total Wages', total_wages)
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3, account, candidate_address, total_wages)
